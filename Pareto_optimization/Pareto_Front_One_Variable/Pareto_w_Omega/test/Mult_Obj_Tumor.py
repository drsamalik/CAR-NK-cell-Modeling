...
def Rho_lambda(a1,alpha4, NK_cell,Target_cell, WT = False):
        x0 = np.array([0.9999359259714925, 6003.305125598019, 0.838786721844546, 0.8295496366780182, 0.17514947140694795, 0.6745540362911091, 0.005765401108091923, 4.597357049853671e-05])
        x = np.array(x0)
